...
Bootstrap::init();
DoorContext::requireDoor('/door/door_login.php');
...
<style>
    #door-scanner-container {
        padding: 16px;
    }

    #door-scanner-container .container {
            max-width: 600px;
            margin: 0 auto;
        }
...
<main class="bg-starfield">
  <div class="container py-5" style="max-width: 800px;">
    ...
    <div class="text-center mx-auto mb-4" style="max-width: 760px;">
      ...
      <p class="text-muted" style="font-size: 1.05rem; line-height: 1.7;">
        ...
        <a href="/door/door_logout.php" class="text-danger" style="text-decoration: none; font-weight: 600;">Abmelden</a>
      </p>
    </div>
  ...
  <script>
            ...
            try {
                ...
                await codeReader.decodeFromVideoDevice(selectedDeviceId, 'video', (result, err) => {
                    ...
                    if (err && err.name !== 'NotFoundException') {
                        // Stiller Fehler: NotFoundException ist normal beim Scannen
                    }
                });
        ...
        async function handleTicketScan(pid, sig) {
            ...
            try {
                const response = await fetch('/door/door_validate_ticket.php', {
                    method: 'POST',
                    headers: {
