...
final class LandingController
{
  ...
  public static function show(): void
  {
    ...
    Layout::header(
      ...
      'Der offizielle Abiball 2026 des BSZ Leonberg am 10. Juli 2026 in der Stadthalle Leonberg. Tickets, Sitzplatzreservierung und alle wichtigen Informationen.',
      '/images/saal.jpeg'
    );
      ...
      <div class="container py-5" style="max-width: 1100px;">
        <div class="text-center mx-auto" style="max-width: 900px; padding-top: 24px; padding-bottom: 28px;">
          ...
          <div class="glass-hero-header mb-4 animate-fade-up">
            ...
            <script>
              (function() {
                // Event-Datum aus PHP Config
                const eventDate = new Date('<?= Config::EVENT_DATE ?>T17:00:00').getTime();
                ...
                function updateCountdown() {
                  ...
                  if (distance < 0) {
                    // Event hat begonnen – Countdown durch Nachricht ersetzen
                    if (countdownContainer) {
                      countdownContainer.innerHTML = '<div style="text-align:center; padding: 16px 24px; border-radius: 12px; background: rgba(201,162,39,.10); border: 1px solid rgba(201,162,39,.25);">' +
                        '<div style="font-size: 1.6rem; font-weight: 600; color: var(--gold); margin-bottom: 4px;">Der Abiball hat begonnen! 🎉</div>' +
                        '<div style="font-size: 0.95rem; color: var(--muted);">Wir wünschen einen wundervollen Abend.</div>' +
                        '</div>';
                    }
                    return;
                  }
