...
final class Layout
{
    ...
    public static function eventStructuredData(): void
    {
        ...
        $eventData = [
            ...
            'startDate' => '2026-07-10T17:00:00+02:00',
            'endDate' => '2026-07-11T02:00:00+02:00',
            'eventStatus' => 'https://schema.org/EventScheduled',
            'eventAttendanceMode' => 'https://schema.org/OfflineEventAttendanceMode',
            'location' => [
                '@type' => 'Place',
                'name' => 'Stadthalle Leonberg',
                'address' => [
                    '@type' => 'PostalAddress',
                    'streetAddress' => 'Römerstraße 110',
...
?>
        ...
        <head>
            ...
            <link rel="preload" as="image" href="/images/marble-bg.png">
